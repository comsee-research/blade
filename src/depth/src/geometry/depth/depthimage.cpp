...
DepthMapImage::DepthMapImage(const PointCloud& pc, const PlenopticCamera& model, double mind, double maxd, bool use_median_as_interpolation_method)
{	
	...
	for(int v = 0; v < img_height; ++v)
	{
		for(int u = 0; u < img_width; ++u)
		{
			if (use_median_as_interpolation_method)
			{
